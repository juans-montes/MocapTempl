...
public class F28 implements Feature
{
	public static final double theta1_1 = 25.0;
	public static final double theta1_2 = 180.0;
	public static final double theta2_1 = 20.0;
	...
	public boolean[] computeFeature(Motion motion)
	{
		...
		Bone j3=motion.skeleton_.bones_.get("lclavicle");
		Bone j4=motion.skeleton_.bones_.get("lhumerus");
