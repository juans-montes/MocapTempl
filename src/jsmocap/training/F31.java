...
public class F31 implements Feature
{
	public static final double theta1 = 0.5;
	public static final double theta2 = 0.35;
	...
	public boolean[] computeFeature(Motion motion)
	{
		...
		Bone j2=motion.skeleton_.bones_.get("thorax");
		...
		for(int i=0; i<motion.frames_.size(); ++i)
		{
			...
			double now=computeDistance(j1, j2, j3, motion.skeleton_);
	...
	public double computeDistance(Bone j1, Bone j2, Bone j3, Skeleton j4)
	{
