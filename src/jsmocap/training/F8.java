...
public class F8 implements Feature
{
	...
	public boolean[] computeFeature(Motion motion)
	{
		...
		Bone j1=motion.skeleton_.bones_.get("lhumerus");
		Bone j2=motion.skeleton_.bones_.get("lclavicle");
		Bone j3=motion.skeleton_.bones_.get("lhumerus");
		Bone j4=motion.skeleton_.bones_.get("lradius");
