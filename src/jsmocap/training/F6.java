...
public class F6 implements Feature
{
	...
	public boolean[] computeFeature(Motion motion)
	{
		...
		Bone j1=motion.skeleton_.bones_.get("lowerback");
		Bone j2=motion.skeleton_.bones_.get("upperback");
		Bone j3=motion.skeleton_.bones_.get("upperback");
		Bone j4=motion.skeleton_.bones_.get("lwrist");
